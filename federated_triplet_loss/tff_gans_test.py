...
class TffGansTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_build_server_initial_state_comp(self, with_dp):
        ...
        if with_dp:
            ...
            self.assertAlmostEqual(
                dp_averaging_state.numerator_state.sum_state.stddev, BEFORE_DP_STD_DEV
            )
    ...
    def test_server_computation(self, with_dp):
        ...
        def _update_dp_averaging_state(with_dp, dp_averaging_state):
            ...
            new_dp_averaging_state["numerator_state"]["sum_state"][
                "l2_norm_clip"
        ...
        final_server_state = server_comp(
            server_state,
            one_dim_gan.create_generator_inputs().take(7),
            client_output,
    ...
    def test_build_gan_training_process(self, with_dp):
        ...
        client_gen_inputs = [
            one_dim_gan.create_generator_inputs().take(i) for i in client_dataset_sizes
        ]
