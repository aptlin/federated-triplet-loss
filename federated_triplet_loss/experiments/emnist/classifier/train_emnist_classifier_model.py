...
flags.DEFINE_string(
    ...
    "/tmp/emnist_classifier_checkpoint.hd5",
...
def _load_and_preprocess_datasets():
    ...
    emnist_train, emnist_test = emnist_data_utils.create_real_images_tff_client_data()
...
def _train_and_evaluate(preprocessed_train_dataset, preprocessed_test_dataset, epochs):
...
def main(argv):
    ...
    model = _train_and_evaluate(
        preprocessed_train_dataset, preprocessed_test_dataset, epochs=FLAGS.epochs
    )
