...
def main(argv):
    ...
    # TFF Dataset.
    client_real_images_tff_data = emnist_data_utils.create_real_images_tff_client_data(
        split="train"
    )
    print("There are %d unique clients." % len(client_real_images_tff_data.client_ids))
